                ...
                <div className="card-body">
                  <div className="dropdown d-inline mr-2">
                    ...
                    <div className="dropdown-menu">
                      <a className="dropdown-item" href="true" onClick={(e) => { e.preventDefault() }}>
                        Action
                      </a>
                      <a className="dropdown-item" href="true" onClick={(e) => { e.preventDefault() }}>
                        Another action
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="dropdown d-inline">
                    ...
                    <div className="dropdown-menu">
                      <a className="dropdown-item has-icon" href="true" onClick={(e) => { e.preventDefault() }}>
                        <i className="far fa-heart"></i> Action
                      </a>
                      <a className="dropdown-item has-icon" href="true" onClick={(e) => { e.preventDefault() }}>
                        <i className="far fa-file"></i> Another action
                      </a>
                      <a className="dropdown-item has-icon" href="true" onClick={(e) => { e.preventDefault() }}>
                        <i className="far fa-clock"></i> Something else here
                      </a>
                    </div>
                  </div>
                </div>
