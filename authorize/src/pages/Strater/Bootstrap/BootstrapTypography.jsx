...
export class BootstrapTypography extends Component {
  componentDidMount() {
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="lead mt-4">
                      Lead &mdash; Vivamus sagittis lacus vel augue laoreet
                    ...
                    <a href="true" onClick={(e) => { e.preventDefault() }}>You can click me!</a>
                  </div>
                </div>
                <div className="card">
                  <div className="card-header">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="colors">
                      ...
                      <div className="color bg-info text-white">
                        <div>Info</div>
                      </div>
                      <div className="color bg-warning text-white">
                        <div>Warning</div>
                      </div>
                      <div className="color bg-danger text-white">
                        <div>Danger</div>
                      </div>
                      <div className="color bg-light">
                        <div>Light</div>
                      </div>
                      <div className="color bg-dark text-white">
                        <div>Dark</div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p>
                      ...
                      adipisicing elit, sed do eiusmod tempor incididunt ut
                      labore et dolore magna aliqua. Ut enim ad minim veniam,
                      quis nostrud <code>exercitation</code> ullamco laboris
                      nisi ut aliquip ex ea commodo consequat.
                    </p>
                    <div className="section-title">Code Block</div>
                    <p>
                      We use PrismJS to do this, you can adjust themes, syntax
                      and more.{" "}
                      <a href="http://prismjs.com">Visit their documentation</a>
                      .
                    </p>
                    <pre className="language-javascript">
                      <code>var code = 'Hello';</code>
                    </pre>
                  </div>
                </div>
                <div className="card">
