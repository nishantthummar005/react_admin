...
const ShowData = (props) => {
    const { getEditItem, reviewAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(reviewContext);
    const { deleteReview, perRowsChange, loading } = context;
    ...
    const columns = [
        ...
        {
            name: 'Message',
            selector: row => row.review_message,
            sortable: true,
            width: "45%"
        },
        {
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Review Data</h2>
                        <p className="section-lead">
                            Get information Review yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/review/add" className="btn btn-info">Add Review</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={reviewAllData.data}>
                                    <DataTable
                                        title="Review Data"
                                        columns={columns}
                                        data={reviewAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={reviewAllData.totalItems}
