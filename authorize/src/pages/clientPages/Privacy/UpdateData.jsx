...
const UpdateData = (props) => {
    ...
    const { updatePrivacyRecord } = context;
    // call udpate API 
    const updateData = async () => {
        updatePrivacyRecord(getEditData._id, getSummerval, page, limit);
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form name='editForm' method="post" autoComplete="off"> 
                                <div className="form-group">
                                    <label htmlFor="privacy" className="form-label"><span className='text-danger'>*</span>Edit Data</label> 
                                    <ReactSummernote
                                        value={getEditData.privacy}
                                        options={{
                                            lang: 'en',
                                            height: 150,
                                            dialogsInBody: true,
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" onClick={updateData} disabled={!getEditData.privacy} form='editForm' className="btn btn-primary">Save changes</button>
                        </div>
                    </div>
                </div>
            </div>
