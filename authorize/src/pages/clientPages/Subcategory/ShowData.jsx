...
const ShowData = (props) => {
    const { getEditItem, subcategoryAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(subcategoryContext);
    const { deleteSubcategory, perRowsChange, loading } = context;
   ...
   ***********************************************/
    ...
    const removeItem = (id) => {
        swal({
            ...
            if (willDelete) {
                try {
                    deleteSubcategory(id, page, limit);
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Subcategory Data</h2>
                        <p className="section-lead">
                            Get information Subcategory yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/subcategory/add" className="btn btn-info">Add Subcategory</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={subcategoryAllData.data}>
                                    <DataTable
                                        title="Subcategory Data"
                                        columns={columns}
                                        data={subcategoryAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={subcategoryAllData.totalItems}
