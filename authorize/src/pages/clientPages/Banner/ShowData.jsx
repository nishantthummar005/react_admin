...
const ShowData = (props) => {
    const { getEditItem, bannerAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(bannerContext);
    const { deleteBanner, perRowsChange, loading } = context;
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Banner Data</h2>
                        <p className="section-lead">
                            Get information Banner yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/banner/add" className="btn btn-info">Add Banner</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={bannerAllData.data}>
                                    <DataTable
                                        title="Banner Data"
                                        columns={columns}
                                        data={bannerAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={bannerAllData.totalItems}
