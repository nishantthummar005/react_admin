...
const UpdateData = (props) => {
    ...
    const { updateGalleryRecord } = context;
    ...
    ***********************************************/
    const onSubmit = data => {
        const { title } = data;
        updateGalleryRecord(getEditData._id, title.trim(), (getProfilePhoto) ? getProfilePhoto : getEditData.path, page, limit); // form submit and insert record    
        reset({ title: '' });
        setProfilePhoto();  // clear selected photos in image
