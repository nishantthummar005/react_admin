...
const ShowData = (props) => {
    const { getEditItem, galleryAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(galleryContext);
    const { deleteGallery, perRowsChange, loading } = context;
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Gallery Data</h2>
                        <p className="section-lead">
                            Get information Gallery yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/gallery/add" className="btn btn-info">Add Gallery</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={galleryAllData.data}>
                                    <DataTable
                                        title="Gallery Data"
                                        columns={columns}
                                        data={galleryAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={galleryAllData.totalItems}
