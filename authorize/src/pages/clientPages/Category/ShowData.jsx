...
const ShowData = (props) => {
    const { getEditItem, categoryAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(categoryContext);
    const { deleteCategory, perRowsChange, loading } = context;
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Category Data</h2>
                        <p className="section-lead">
                            Get information Category yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/category/add" className="btn btn-info">Add Category</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={categoryAllData.data}>
                                    <DataTable
                                        title="Category Data"
                                        columns={columns}
                                        data={categoryAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={categoryAllData.totalItems}
