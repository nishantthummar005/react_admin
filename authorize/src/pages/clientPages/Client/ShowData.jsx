...
const ShowData = (props) => {
    const { getEditItem, clientAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(clientContext);
    const { deleteClient, perRowsChange, loading } = context;
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Client Data</h2>
                        <p className="section-lead">
                            Get information Client yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/client/add" className="btn btn-info">Add Client</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={clientAllData.data}>
                                    <DataTable
                                        title="Client Data"
                                        columns={columns}
                                        data={clientAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={clientAllData.totalItems}
