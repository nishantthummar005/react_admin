...
const ShowData = (props) => {
    const { getEditItem, aboutAllData, page, setPage, limit, setlimit } = props;
    const context = useContext(aboutusContext);
    const { deleteAboutus, perRowsChange, loading } = context;
    ...
    return (
        <>
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="section-title mt-0">Show Aboutus Data</h2>
                        <p className="section-lead">
                            Get information Aboutus yourself on this page.
                        </p>
                    </div>
                    <div className="col-6 text-right">
                        <Link to="/clientPages/aboutus/add" className="btn btn-info">Add Aboutus</Link>
                    </div>
                </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="card card-primary">
                            <div className="card-body">
                                <DataTableExtensions columns={columns} data={aboutAllData.data}>
                                    <DataTable
                                        title="About us Data"
                                        columns={columns}
                                        data={aboutAllData.data}
                                        ...
                                        pagination
                                        paginationServer
                                        paginationTotalRows={aboutAllData.totalItems}
