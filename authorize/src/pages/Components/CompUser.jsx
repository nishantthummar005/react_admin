                ...
                <div className="card author-box card-primary">
                  <div className="card-body">
                    ...
                    <div className="author-box-details">
                      ...
                      <a href="true" onClick={(e) => { e.preventDefault() }} className="btn btn-social-icon mr-1 btn-facebook">
                        <i className="fab fa-facebook-f"></i>
                      </a>
                      <a href="true" onClick={(e) => { e.preventDefault() }} className="btn btn-social-icon mr-1 btn-twitter">
                        <i className="fab fa-twitter"></i>
                      </a>
                      <a href="true" onClick={(e) => { e.preventDefault() }} className="btn btn-social-icon mr-1 btn-github">
                ...
                <div className="card card-danger">
                  <div className="card-header">
                    ...
                    <div className="card-header-action">
                      <a href="true" onClick={(e) => { e.preventDefault() }} className="btn btn-danger btn-icon icon-right">
              ...
              <div className="col-12 col-sm-12 col-lg-5">
                <div className="card profile-widget">
                  ...
                  <div className="card-footer text-center pt-0">
                    ...
                    <a href="true" onClick={(e) => { e.preventDefault() }} className="btn btn-social-icon mr-1 btn-instagram">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
                      ...
                      <li className="media">
                        ...
                        <div className="media-body">
                          ...
                          <div className="media-links">
                            <a href="true" onClick={(e) => { e.preventDefault() }}>View</a>
                            <div className="bullet"></div>
                            <a href="true" onClick={(e) => { e.preventDefault() }}>Edit</a>
                            <div className="bullet"></div>
                            <a href="true" onClick={(e) => { e.preventDefault() }} className="text-danger">
                              Trash
                            </a>
                          </div>
                        </div>
